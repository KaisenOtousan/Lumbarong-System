...
<div class="space-y-10">
                                ...
                                <div class="grow">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        @if($banner->button_text_1 && $banner->button_url_1)
                                            <a href="{{ $banner->button_url_1 }}" class="px-6 py-3 bg-[#C0422A] text-white text-xs font-black uppercase tracking-widest rounded-full hover:bg-white hover:text-black transition-all">
    ...
    <div class="flex flex-wrap items-center gap-3">
        ...
        <form action="/" method="GET" class="flex-1 min-w-[260px] relative">
            @if(request('category'))
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-[#2A2A28]">
                    {{ request('category') ? request('category').' Collection' : (request('search') ? 'Search Results' : 'Recommended Products') }}
                </span>
            </div>
