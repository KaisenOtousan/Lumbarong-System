                ...
                <div class="flex flex-col lg:flex-row gap-10">
                    ...
                    <div class="flex-1 space-y-5">
                        ...
                        <div class="grid grid-cols-[160px_1fr] items-center gap-4">
                            <label class="text-sm text-gray-500 text-right">Username</label>
                            <div>
                                <div class="h-10 px-4 bg-gray-50 border border-gray-200 rounded-lg flex items-center text-sm text-gray-400 select-none">
                                    {{ $user->username ?? $user->name }}
                                </div>
                                <p class="text-[11px] text-gray-400 mt-1">Username cannot be changed.</p>
                            </div>
                        </div>
                        ...
                        {{-- Phone --}}
                        <div class="grid grid-cols-[160px_1fr] items-center gap-4">
                            <label class="text-sm text-gray-500 text-right" for="mobileNumber">Phone Number</label>
                            <input id="mobileNumber" type="text" name="mobileNumber" value="{{ old('mobileNumber', $user->mobileNumber) }}"
                        ...
                        {{-- Gender --}}
                        <div class="grid grid-cols-[160px_1fr] items-center gap-4">
                            <label class="text-sm text-gray-500 text-right">Gender</label>
                        ...
                        {{-- Birthday --}}
                        <div class="grid grid-cols-[160px_1fr] items-center gap-4">
                            <label class="text-sm text-gray-500 text-right" for="birthday">Date of Birth</label>
                            <input id="birthday" type="date" name="birthday"
                                value="{{ old('birthday', $user->birthday ? \Carbon\Carbon::parse($user->birthday)->format('Y-m-d') : '') }}"
                                class="h-10 px-4 bg-white border border-gray-200 rounded-lg text-sm outline-none focus:border-[#C0420A] transition-colors w-full max-w-[200px]">
                        </div>
